// Renders the Hero + Split poster to a 300 DPI print PNG, an A4 PDF, and a web preview PNG.
// Run: node poster/render-hero-split.mjs
import puppeteer from 'puppeteer';
import { fileURLToPath } from 'node:url';
import { dirname, join } from 'node:path';

const __dirname = dirname(fileURLToPath(import.meta.url));
const fileUrl = 'file://' + join(__dirname, 'poster-hero-split.html');
const NAME = 'studio-north-photography-2b-hero-split';
